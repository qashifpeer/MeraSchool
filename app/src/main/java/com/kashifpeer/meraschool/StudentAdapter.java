...
class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentViewHolder> {
    ArrayList<com.kashifpeer.meraschool.StudentItem> studentItems;
    Context context;
    ...
    public StudentAdapter(Context context, ArrayList<com.kashifpeer.meraschool.StudentItem> studentItems) {
