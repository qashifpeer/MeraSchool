...
public class StudentActivity extends AppCompatActivity {
    ...
    private ArrayList<com.kashifpeer.meraschool.StudentItem> studentItems = new ArrayList<>();
    ...
    private void loadData() {
        ...
        while (cursor.moveToNext()) {
            ...
            studentItems.add(new com.kashifpeer.meraschool.StudentItem(sid, roll, name));
        }
        cursor.close();
    }
    ...
    private void saveStatus() {
        for (com.kashifpeer.meraschool.StudentItem studentItem : studentItems) {
    ...
    private void showAddStudentDialog() {
        com.kashifpeer.meraschool.MyDialog dialog = new com.kashifpeer.meraschool.MyDialog();
        dialog.show(getSupportFragmentManager(), com.kashifpeer.meraschool.MyDialog.STUDENT_ADD_DIALOG);
    ...
    private void addStudent(String roll_string, String name) {
        ...
        com.kashifpeer.meraschool.StudentItem studentItem = new com.kashifpeer.meraschool.StudentItem(sid, roll, name);
    ...
    private void showUpdateStudentDialog(int position) {
        com.kashifpeer.meraschool.MyDialog dialog = new com.kashifpeer.meraschool.MyDialog(studentItems.get(position).getRoll(), studentItems.get(position).getName());
        dialog.show(getSupportFragmentManager(), com.kashifpeer.meraschool.MyDialog.STUDENT_UPDATE_DIALOG);
